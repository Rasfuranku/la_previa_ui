      ...
      >
        ...
        <div className="glass-panel p-8 rounded-3xl space-y-8 border border-white/10 bg-black/40 backdrop-blur-md">
          <div className="text-center">
            ...
            <p className="text-muted text-sm">Enter your credentials to access the pitch.</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center px-1">
                ...
                {/* Forgot password link - pointing to # for now */}
                <Link href="#" className="text-[10px] text-primary hover:underline uppercase font-bold">
                  Forgot?
                </Link>
              </div>
              <input
